...
public class RefugioService {
    ...
    public List<RefugioResponse> listar() {
        return refugioRepository.findAll().stream().map(this::toResponse).toList();
    }
    ...
    public RefugioResponse crear(RefugioRequest request) {
        ...
        refugio.setDireccion(direccionService.guardar(request.direccionEfectiva()));
        aplicarDatos(refugio, request);
        return toResponse(refugioRepository.save(refugio));
    }
    ...
    public RefugioResponse actualizar(Long id, RefugioRequest request) {
        ...
        if (request.getDireccion() != null || request.getDomicilio() != null) {
            direccionService.actualizar(refugio.getDireccion(), request.direccionEfectiva());
        }
        aplicarDatos(refugio, request);
        return toResponse(refugioRepository.save(refugio));
    }
    ...
    public void eliminar(Long id) {
        ...
        direccionService.eliminar(refugio.getDireccion());
    }
    ...
    private RefugioResponse toResponse(Refugio refugio) {
        RefugioResponse res = RefugioResponse.from(refugio);
        res.setDireccion(direccionService.toDto(refugio.getDireccion()));
        return res;
    }
